...
- Metrics displaying as expected
...
The metrics that we displayed above are default metrics for ec2, the metrics we are more concerned about are the ones monitored by our Cloudwatch agents
